# Just Math Malaysia — final page copy

Everything below goes on the page. Nothing below is a note. Set in order.
...
Four items, one row on desktop, two by two on mobile. Static text, no animated counters.

- 24 years teaching maths
- 10 years teaching online
- 500+ students, taught one at a time
...
**Heading**
The school system checks your child's maths twice before SPM
...
Working is shown line by line, every time, including the steps most people skip because they seem obvious. The steps that seem obvious to a teacher are usually the exact ones a struggling student cannot see. A student who watches a solution appear in three lines learns nothing. A student who watches it appear in eleven can reproduce it on their own.

**Subheading**
Online is not a downgrade, and I have ten years of evidence
...
**Subheading**
Taught in the language your child thinks in

Sessions run in English or Bahasa Melayu, and switch mid-explanation when that is what it takes. A student who understands the maths but not the wording of the question does not have a maths problem, and treating it as one wastes everybody's time.

**Subheading**
How you see progress

At the end of every month you get a written progress summary: what was covered, what improved, what is still weak, what we are working on next. Not a WhatsApp message saying "she's doing well."

**Subheading**
What a self-study app cannot do

An app can tell you a question was answered wrongly. It cannot tell you why. The why is almost always a concept from two or three years earlier, and finding it is the job.
...
Four blocks, then one short closing statement set apart from them.

### Block one — Standard 1 to Standard 6

Building number confidence before the gaps become invisible.
...
Where maths stops being arithmetic and starts being abstract.
...
### Block three — Form 4 and Form 5

Modern Mathematics, Additional Mathematics, and the SPM paper.
...
### Closing statement, set apart from the four blocks
...
**Byline, small, above the heading**
Mr Kong, Just Math Malaysia

**Photograph**
One portrait of Mr Kong sits in this section. Ideally at the desk where he teaches, with the screen and writing setup visible, because it makes the ten years online and the shared whiteboard concrete rather than claimed. A plain head and shoulders is the fallback. No caption needed; the byline above does that work. This is the only photograph on the page.

**Heading**
Can one tutor teach a seven-year-old and an Add Maths student?
...
**Heading**
One session a week, billed monthly
...
| Level | Session | Per month | Per session |
|---|---|---|---|
| Standard 1 to 6 | 60 min | RM160 | RM40 |
| Form 1 to 3 | 60 min | RM180 | RM45 |
| Form 4 and 5, Modern Mathematics | 60 min | RM200 | RM50 |
| Form 4 and 5, Additional Mathematics | 60 min | RM240 | RM60 |
| IGCSE Mathematics and Additional Mathematics | 90 min | RM360 | RM90 |
...
Tell me what standard or form your child is in. That is all I need to get started.

**2. Free 30-minute assessment on Google Meet**
Your child works through problems with me while I watch how they think, not just whether they get the answer. You are welcome to sit in.

**3. You get the findings**
I tell you what is solid, what is weak, and which earlier topic is causing the current problem. If I think your child does not need tutoring, I will say so.

**4. Your weekly slot starts**
If you want to go ahead, we agree a slot from what is available, weekly and the same time each week. The first month's fee is settled before the first session, and we start on the plan from the assessment.

---

## 9. FAQ

Thirteen items, accordion. First one open by default.
...
**Will the same tutor teach every session?**
...
## Button link, for the build

All five buttons carry the same label and the same link.
...
There is no testimonials section on this page. That is deliberate.
